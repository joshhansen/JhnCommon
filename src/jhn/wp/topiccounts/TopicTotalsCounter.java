...
public class TopicTotalsCounter {
	...
	public static void main(String[] args) throws CorruptIndexException, IOException {
		...
		final String topicWordIdxDir = jhn.Paths.topicWordIndexDir("wp_lucene4");
		IndexReader src = IndexReader.open(FSDirectory.open(new File(topicWordIdxDir)));
//		final String destFilename = jhn.Paths.outputDir("EDA") + "/indices/topic_totals/topic_totals.sqlite3";
		final String destFilename = jhn.Paths.outputDir("EDA") + "/indices/topic_counts/topic_counts.ser";
